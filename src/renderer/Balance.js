      ...
      <div className={styles["balance-details-content"]}>
        <div className={styles["balance-box"]}>
          ...
          <div style={{display: 'flex', justifyContent: 'flex-end'}}>
            <button style={{fontSize: "24px", marginRight: '8px'}} className={styles["edit-button"]} onClick={editBalanceStart}>
              <MdEdit />
            </button>
          </div>
          <div className={styles["balance-details"]}>
            ...
            <div className={styles["income-expense-details"]}>
              ...
              <div>
                ...
                {
                  balanceEditMode ?
                  <input className={styles["balance-input"]} onChange={(e) => {setIncomeYear(e.target.value)}} value={incomeYear}></input>
                  :
              ...
              <div className={styles["overview-subtitle"]}>
                ...
                {
                  balanceEditMode ?
                  <input className={styles["balance-input"]} onChange={(e) => {setExpenseYear(e.target.value)}} value={expenseYear}></input>
                  :
                  <p className={styles["expenses"]}>${(Math.round(balanceDetails.expensesYear * 100) / 100).toFixed(2)}</p>
                }
              </div>
            </div>
          </div>
